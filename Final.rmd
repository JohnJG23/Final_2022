...
Interestingly in this scenario the test results read p-value = 1e-08, alternative hypothesis: true odds ratio is not equal to 1, 95 percent confidence interval: 0.066 0.344, sample estimates: odds ratio 0.16, and going from these results we can also assume that there is also no association between the effectiveness across the variety of sub populations tracked, but the female, male, and these results say otherwise. The vaccine was slightly more effective in protecting LGBTQ people from covid.  
...
In general, an odds ratio indicates a strong association. Since this ratio is 14 it is smaller than the males odds ratio. Though, taking into account that the number of observations in the data for males is much higher than that of the LGBTQ data then there is a chance that the vaccine is effective. That is why it appears to be that there is a significant association between the vaccine and LGBTQ analysis.  
...
The barplot above here shows the percent of drug user individuals who were infected with covid19 and who were OK. The pink bars are people who received the vaccine and the blue bars are the people who received the placebo. In this barchart there was a much greater reported number of covid19 patients who received a vaccine over the covid19 patients who received a placebo and then there was a slightly bigger number of reported patients who are OK but received a vaccine over ones who were OK and received the placebo.  
...
Interestingly in this scenario the test results read p-value = 3e-07, alternative hypothesis: true odds ratio is not equal to 1, 95 percent confidence interval: 0.094 0.418, sample estimates: odds ratio 0.21, and going from these results we can also assume that there is also no association between the effectiveness across the variety of sub populations tracked, but these results say otherwise. The vaccine was slightly more effective in protecting the drug using sub populations from covid.
...
In general, an odds ratio indicates a strong association. Since this ratio is 17 it is smaller than the previous odds ratio's. Though, taking into account that the number of observations in the data for males is much higher than that of the drug user sub population data then there is a chance that the vaccine is effective. That is why it appears to be that there is a significant association between the vaccine and the drug user analysis.   


# Overall Results and Conclusions

After investigating the trials of a new  preventative vaccine. I learned that the null hypothesis was that the vaccine was effective effective in preventing infection from the covid19 epidemic across a variety of sub populations tracked and the alternative hypothesis was that the vaccine has exhibited different effectiveness across the variety of sub populations tracked. The first group was the males. After investigating how to build models that produced the outcomes needed I made an assessment based off of these outcomes. Based off of the Fisher's Exact Test for the male Count Data the vaccine is not effective and reject the null hypothesis and accept the alt hypothesis that is that the vaccine has exhibited different effectiveness across this variety of the sub populations tracked. Interestingly for every sub population tracked further investigation resulted in the outcome of rejecting the null hypothesis and accepting the alternative hypothesis. Based off of the models built I learned this, there is strong evidence supporting the alternative hypothesis in these models. For example the automated response for the P value in the sub groups tracked is, male p-value is 2e-12, female p-value is 0.005, LGBTQ p-value is 1e-08, and the drug user p-value is 3e-07. A statistically significant test result (P ≤ 0.05) means that the test hypothesis is false or should be rejected. After going through every sub population the outcome for the p value was a number extremely small and less than the 0.05 significant result. Therefor the vaccine should not be recommended, as it stands in these clinical trails.
...
The male's numerical results displays the statistical results for an infected, ok, and vaccinated or not vaccinated male. On the fist table it reads that there are 68 males that are sick but are given a plecebo or fake medications out of 100 males and 32 males who were given a vaccine out of the 100 males. Then the table below the displays that there is a 2.7 percent more likely chance of a man becoming sick with a placebo effect and a 1.2 chance of you becoming sick with a vaccine. Secondly the Ok patients result reads 97.3 for placebo and 98.8 for vaccine. According to this numerical results they are still at risk since the placebo effect is a less percent than the vaccinated percent of males.
